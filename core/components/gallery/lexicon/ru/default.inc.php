...
$_lang['gallery.item_url_desc'] = 'URL для просмотра при нажимании на изображение.';
$_lang['gallery.item_customthumb'] = 'Собственная миниатюра';
$_lang['gallery.item_customthumb_desc'] = 'URL собственной миниатюры (можно относительный).';
