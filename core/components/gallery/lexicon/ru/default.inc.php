...
$_lang['gallery.album_update'] = 'Обновить альбом';
...
$_lang['gallery.comma_separated_list'] = 'Список разделённый запятыми.';
...
$_lang['gallery.inactive'] = 'Неактивна';
...
$_lang['gallery.item_update'] = 'Обновить элемент';
